...
parser.add_argument('--start_date', nargs=1, type= str, default=sys.stdin, help = 'From to which date to start to include data.')
...
def read_and_format_data(us_deaths, mobility_data, modeled_summary, population_sizes, N2, end_date):
        ...
        #Select data from start date up to end date
        mobility_data = mobility_data[mobility_data['date']<=end_date]
        #Select data up to end date
        mobility_data = mobility_data[mobility_data['date']>=start_date]
