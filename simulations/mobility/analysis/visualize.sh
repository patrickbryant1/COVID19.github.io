...
/home/patrick/COVID19.github.io/simulations/mobility/analysis/visualize_model_output.py --datadir $DATADIR --countries $COUNTRIES --days_to_simulate $DTS --end_date $ED --short_dates $SD --outdir $OUTDIR
