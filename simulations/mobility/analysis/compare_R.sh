...
INTERVENTIONS=../data/interventions_only.csv
#Visualize model output
./compare_R_estimates.py --EpiEstimdir $EPIESTIMDIR --stan_results $STAN_RESULTS --country_meta $CM --end_date $ED --short_dates $SD --interventions $INTERVENTIONS --outdir $OUTDIR
