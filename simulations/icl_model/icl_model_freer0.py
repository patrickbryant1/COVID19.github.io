...
def fix_covariates(covariates):
        ...
        '''
        NPI = ['schools_universities',  'public_events',   'social_distancing_encouraged', 'self_isolating_if_ill']
...
def read_and_format_data(datadir, countries):
        ...
        #Get epidemic data
        epidemic_data = pd.read_csv(datadir+'ecdc_20200415.csv')
        #Convert to datetime
        ...
        #Create stan data
        N2=90 #Increase for further forecast
        ...
        covariate_names = ['any_intervention']
